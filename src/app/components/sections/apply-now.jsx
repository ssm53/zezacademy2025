      ...
      try {
        ...
        if (response.ok) {
          ...
          window.location.href =
            "https://calendly.com/shaun-ravewavedigital/30min";
          return;
        } else {
          alert("Error submitting the form. Please try again.");
        }
                ...
                {thankYouMessage ? (
                  ...
                  <form className="space-y-5" onSubmit={handleSubmit}>
                    ...
                    >
                      ...
                      {loading ? (
  <span className="inline-flex items-center justify-center text-center gap-2">
    ...
    <span className="leading-snug">
      ...
      <span className="block text-xs opacity-80">
        You’ll be redirected to our interview booking page.
      </span>
    </span>
  </span>
) : (
