      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white shadow-lg rounded-lg p-6">
          ...
          <div className="relative bg-darkBlue text-white p-6 rounded-lg">
            {/* Discount Badge */}
            <div className="absolute top-0 right-0 bg-yellow-400 text-darkBlue text-xs font-bold rounded-full px-4 py-1 -mt-4 -mr-4">
              90% OFF
            </div>
            {/* Price Details */}
            ...
            <a
              href="#"
              className="inline-block mt-4 bg-primary hover:bg-primary-dark text-white font-semibold text-center rounded-lg px-6 py-3"
            >
              Apply Now
            </a>
          </div>
