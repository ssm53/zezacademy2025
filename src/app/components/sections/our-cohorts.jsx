    ...
    <section className="max-w-7xl mx-auto px-4 py-16">
      ...
      <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 text-center">
          <h3 className="text-xl font-bold text-primary">15th Oct, 2024</h3>
          <p className="text-gray-600 mt-2">5 Spots left</p>
        </div>

        {/* Date Card 2 */}
        <div className="bg-white shadow-lg rounded-lg p-6 text-center">
          <h3 className="text-xl font-bold text-primary">15th Feb, 2024</h3>
          <p className="text-gray-600 mt-2">6 Spots left</p>
        </div>

        {/* Date Card 3 */}
        <div className="bg-white shadow-lg rounded-lg p-6 text-center">
          <h3 className="text-xl font-bold text-primary">15th Jun, 2024</h3>
          <p className="text-gray-600 mt-2">6 Spots left</p>
        </div>
      </div>
    </section>
